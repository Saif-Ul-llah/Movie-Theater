...
var tac =  document.getElementById("col-md-7-11");
...
function login(){
    ...
    if(email!=data.email){
        ...
        var r =document.getElementById("ticket");
...
function del(){
    ...
    var sign=document.getElementById("sign");
    var pr =document.getElementById("ticket");
...
function tick(arg){
        // console.log(arg);
        var no = arg ;
        var get = document.getElementById(no);
        var im=get.childNodes[1].src;
        var bo =document.getElementById("chance");
        bo.setAttribute("src",im); 
        var x= get.childNodes[5].childNodes[0].nodeValue;
        var tx= get.childNodes[3].childNodes[0].nodeValue;
        // tx=JSON.stringify(tx);
        document.getElementById("title").innerHTML= tx;
        var boo= document.getElementById("book");
        document.getElementById("gtext").innerHTML= x;
        var o= document.getElementById("book");
...
function clo(){
    var clos = document.getElementById("book");
